...
public class NecroEntityWitch extends NecroEntityVillager {
    ...
    public void initRecipes() {
        initDefaultRecipes(Item.poisonousPotato);
    }
	...
	public void setAttributes(EntityLivingBase minion, BodyPartLocation location) {
		if(location == BodyPartLocation.Head) {
			...
			armLeft[0].attributes.func_111150_b(SharedMonsterAttributes.field_111267_a).func_111128_a(3.0D); //health
			...
			armRight[0].attributes.func_111150_b(SharedMonsterAttributes.field_111267_a).func_111128_a(3.0D); //health
