...
public class EntityMinion extends EntityTameable {
	...
	public boolean interact(EntityPlayer par1EntityPlayer) {
		...
		} else if (riddenByEntity == null && !par1EntityPlayer.username.equalsIgnoreCase(this.getOwnerName()) && FMLCommonHandler.instance().getSide() == net.minecraftforge.fml.relauncher.Side.CLIENT && !worldObj.isRemote) {
